...
const Hero = () => {
  ...
  return (
    ...
    >
        ...
        <p className='font-montserrat text-lg mt-6 mb-14 text-slate-gray leading-8 sm:max-w-sm'> Discover stylish Nike arrivals, quality <br /> comfort, and innovation for
        your active life.</p>
        <Buttton 
        label= "Shop now" 
        iconURL = {arrowRight}
        ...
        <div 
        className={`relative flex-1 flex flex-col justify-center items-center xl:min-h-screen max-xl:py-40 bg-hero bg-cover bg-center bg-primary`}>
          <img 
